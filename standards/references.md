...
| 代码类型 | 典型得分区间 |
|----------|-------------|
| 优秀生产级代码（如知名开源库） | 54–60 / 60 |
| 普通生产级代码（规范但不追求极致） | 42–53 / 60 |
| vibe coding 原型（AI 生成、未经重构） | 30–41 / 60 |
| 快速脚本 / 一次性代码 | 18–29 / 60 |
...
| v0.7 | 行业基准分表与 calibrate 命令期望区间对齐，各类型区间上调约 6 分（基于 VibeCoding--RAG 校准，共 1 处修改） |